...
/**
 * Releases both the device and the circuit reservations held for a site type change.
 *
 * @see org.example.am.shared.domain.NetworkChangeRequest#isComplexScheduling()
 */
public class CancelNCRDateProcedureComplex extends StoredProcedure {
    ...
    public String cancel(final long networkChangeRequestId, final long assetId, final String reason,
            final String userId) {
